...
class Profile(models.Model):
    ...
    github = models.URLField(default='', blank=True, max_length=255, unique=True)
    linkedIn = models.URLField(default='', blank=True, max_length=255, unique=True)
    telegram = models.URLField(default='', blank=True, max_length=255, unique=True)
...
class Project(models.Model):
    ...
    preview = models.ImageField(default='', blank=True, upload_to='images/project_previews/')
    description = RichTextField(default='', blank=True)
    profile = models.ForeignKey(Profile, default='', on_delete=models.CASCADE)
    slideshow = models.OneToOneField(SlideShow, blank=True, null=True, on_delete=models.SET_NULL)
